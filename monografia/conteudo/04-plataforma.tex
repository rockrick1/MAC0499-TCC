...
%     \caption{Singleton (\ref{Singletons}) para recuperação de nós importantes para o jogo\label{prog:main_nodes_getter}.}
% \end{program}
...
%     \caption{Singleton (\ref{Singletons}) para recuperação de arquivos no banco de dados do jogo\label{prog:db_manager}.}
% \end{program}
