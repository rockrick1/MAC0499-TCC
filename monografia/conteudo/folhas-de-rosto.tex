...
\tituloport{Balanceamento Dinâmico de Dificuldade em Jogos Eletrônicos}

% Se "\title" está em português, você pode definir o título em inglês aqui;
% caso contrário, remova
\tituloeng{Dynamic Difficulty Balancing in Video Games}
...
\orientadoreng{Prof. Dr. Marco Dimas Gubitoso}
...
\datadefesa{18 de Janeiro de 2021}

% Se isto não for definido, "\datadefesa" é utilizado no lugar
\datadefesaeng{January 18th, 2021}
...
\palavraschave{Dificuldade. Balanceamento dinâmico. Lógica matemática. Jogos eletrônicos.}
...
À minha namorada, que acompanhou e me apoiou em todos os momentos de desenvolvimento e estudo do trabalho, me ajudando a superar todos os desafios encontrados. Aos meus familiares que sempre me apoiaram totalmente em toda e qualquer escolha, aos meus amigos que me apoiaram ao longo de todos os anos da faculdade e do colégio, e a todos os professores do IME e integrantes do USPGameDev, que tornaram esse estudo possível.
...
% \disablenewpage{\chapter*{Terminologia}}

% \begin{tabular}{rl}
% Console & Aparelho dedicado a rodar um determinado grupo de jogos, com hardwares de interface (ex.: Playstation 2, Nintendo GameBoy, Xbox360)\\
% Singleplayer & Modo/gênero de jogo em que se joga sozinho\\
% Local Multiplayer & Modo/gênero de jogo em que se joga acompanhado de outros jogadores, no mesmo ambiente/console\\
% Online Multiplayer & Modo/gênero de jogo em que se joga acompanhado de outros jogadores, estes jogando através de outros aparelhos\\
% \end{tabular}
